...
namespace AuctionService.UnitTests
{
    public class AuctionControllerTests
    {
        ...
        public AuctionControllerTests()
        {
            ...
            _controller = new AuctionController(_repositoryMock.Object, _mapper, _publishEndpointMock.Object)
            {
        ...
        [Fact]
        public async Task GetAuction_WithNo_Params_Retruns10Auciton()
        {
        ...
        [Fact]
        public async Task GetAuctionById_With_Valid_Params_RetrunsAuction()
        {
        ...
        [Fact]
        public async Task GetAuctionById_With_InValid_Guid_RetrunsNotFound()
        {
            _repositoryMock.Setup(repo => repo.GetAuctionByIdAsync(It.IsAny<Guid>()))
        ...
        public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
        {
            ...
            auction.Seller = "test";
            var updateDto = _fixture.Create<UpdateAuctionDtos>();
        ...
        public async Task UpdateAuction_WithInvalidGuid_ReturnsNotFound()
        {
            ...
            auction.Seller = "huseyin";
            var updateDto = _fixture.Create<UpdateAuctionDtos>();
            _repositoryMock.Setup(repo => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync((Auction)null);
        ...
        public async Task DeleteAuction_WithValidUser_ReturnsOkResponse()
        {
            ...
            auction.Seller = "test";
            _repositoryMock.Setup(repo => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(auction);
            _repositoryMock.Setup(repo => repo.RemoveAuction(It.IsAny<Auction>()));
            _repositoryMock.Setup(repo => repo.SaveChangesAsync()).ReturnsAsync(true);
        ...
        public async Task DeleteAuction_WithInvalidGuid_Returns404Response()
        {
            var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
            auction.Item = _fixture.Build<Item>().Without(x => x.Auction).Create();
            _repositoryMock.Setup(repo => repo.GetAuctionEntityById(Guid.Empty)).ReturnsAsync(auction);
